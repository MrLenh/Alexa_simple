...
const char* ssid = "UOYmedia2";
const char* password = "T!nT!nT!n";
...
void outletOneOn() {
  //  Serial.println("Socket 1 turn on ...");
  digitalWrite(relayFour, LOW);   // sets relayThree on
  lcd.setCursor(0, 2);
  lcd.print("Outlet One: On      ");
  Serial.println("Outlet One: On    ");
}

void outletOneOff() {
  // Serial.println("Socket 1 turn off ...");
...
void outletTwoOn() {
  // Serial.println("Socket 2 turn on ...");
  digitalWrite(relayTwo, LOW);   // sets relayFour on
  lcd.setCursor(0, 3);
  lcd.print("Outlet Two: On      ");
  Serial.println("Outlet Two: On     ");
}

void outletTwoOff() {
  // Serial.println("Socket 2 turn off ...");
  digitalWrite(relayTwo, HIGH);   // sets relayFour off
  lcd.setCursor(0, 3);
  lcd.print("Outlet Two: Off     ");
  Serial.println("Outlet Two: Off     ");
}
